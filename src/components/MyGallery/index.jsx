      ...
      <Gallery>
        <div className={`${css.galleryItem} ${css.galleryItemBig}`}>
          <Item
            ...
            height="550"
          >
            {({ ref, open }) => <img ref={ref} alt={''}  width="550"  height="550" onClick={open} src={Image_4} />}
          </Item>
        </div>

        <div className={`${css.galleryItem} ${css.galleryItemBig}`}>
          <Item key={'item_2'} original={`${Image_5}`} thumbnail={`${Image_5}`} width="640" height="579">
            {({ ref, open }) => <img ref={ref} alt={''} width="640" height="579" onClick={open} src={Image_5} />}
          </Item>
        </div>

        <div className={css.galleryItem}>
          <Item key={'item_3'} original={`${Image_2}`} thumbnail={`${Image_2}`} width="480" height="571">
            {({ ref, open }) => <img ref={ref} alt={''} width="480" height="571" onClick={open} src={Image_2} />}
          </Item>
        </div>

        <div className={css.galleryItem}>
          <Item key={'item_4'} original={`${Image_1}`} thumbnail={`${Image_1}`} width="550" height="550">
            {({ ref, open }) => <img ref={ref} alt={''} onClick={open} src={Image_1} width="550" height="550"/>}
          </Item>
        </div>

        <div className={css.galleryItem}>
          <Item key={'item_5'} original={`${Image_3}`} thumbnail={`${Image_3}`} width="570" height="565">
            {({ ref, open }) => <img ref={ref} alt={''} onClick={open} src={Image_3}  width="570" height="565" />}
          </Item>
        </div>
      </Gallery>
    </div>
